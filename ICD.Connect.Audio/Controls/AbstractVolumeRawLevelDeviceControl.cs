...
{
	public abstract class AbstractVolumeRawLevelDeviceControl<T> : AbstractVolumeLevelDeviceControl<T>, IVolumeRawLevelDeviceControl
		where T : IDeviceBase
	{
		...
		protected AbstractVolumeRawLevelDeviceControl(T parent, int id)
			: base(parent, id)
		{
		}
		...
		public override IEnumerable<IConsoleNodeBase> GetConsoleNodes()
		{
			...
			foreach (IConsoleNodeBase node in VolumeRawLevelDeviceControlConsole.GetConsoleNodes(this))
				yield return node;
		}
		...
		public override void BuildConsoleStatus(AddStatusRowDelegate addRow)
		{
			...
			VolumeRawLevelDeviceControlConsole.BuildConsoleStatus(this, addRow);
		}
		...
		public override IEnumerable<IConsoleCommand> GetConsoleCommands()
		{
			...
			foreach (IConsoleCommand command in VolumeRawLevelDeviceControlConsole.GetConsoleCommands(this))
				yield return command;
		}
