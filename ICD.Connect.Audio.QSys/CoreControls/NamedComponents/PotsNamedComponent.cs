...
namespace ICD.Connect.Audio.QSys.CoreControls.NamedComponents
{
	public sealed class PotsNamedComponent : AbstractNamedComponent
	{
		...
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.*";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.0";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.1";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.2";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.3";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.4";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.5";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.6";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.7";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.8";
		public const string CONTROL_CALL_AUTOANSWER = "call.pinpad.9";
		public const string CONTROL_CALL_AUTOANSWER = "call.ring";
		public const string CONTROL_CALL_AUTOANSWER = "call.ringing";
		public const string CONTROL_CALL_AUTOANSWER = "call.state";
		public const string CONTROL_CALL_AUTOANSWER = "call.status";
		public const string CONTROL_CALL_AUTOANSWER = "call.waiting";
		public const string CONTROL_CALL_AUTOANSWER = "caller.ID.index";
		public const string CONTROL_CALL_AUTOANSWER = "caller.ID.word.0";
		public const string CONTROL_CALL_AUTOANSWER = "caller.ID.word.1";
		public const string CONTROL_CALL_AUTOANSWER = "caller.ID.word.2";
		public const string CONTROL_CALL_AUTOANSWER = "caller.ID.word.3";
		public const string CONTROL_CALL_AUTOANSWER = "caller.ID.word.4";
		public const string CONTROL_CALL_AUTOANSWER = "do.not.disturb";
