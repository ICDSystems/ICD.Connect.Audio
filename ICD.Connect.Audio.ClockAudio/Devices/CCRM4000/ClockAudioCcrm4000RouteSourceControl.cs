...
{
	public sealed class ClockAudioCcrm4000RoutSourceControl : AbstractRouteSourceControl<ClockAudioCcrm4000Device>
	{
		/// <summary>
		...
		/// <param name="id"></param>
		public ClockAudioCcrm4000RoutSourceControl(ClockAudioCcrm4000Device parent, int id)
			: base(parent, id)
		{
		}
